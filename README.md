...
either in the form of image input or drawing directly on a tablet, and by using AI, generate a series of fonts that companies could use for practical and/or commercial use.
